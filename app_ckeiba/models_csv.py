...
class Trn_Trifecta_dividend_TB4(models.Model):
    ...
    Horce_No_6_1 = models.CharField(verbose_name="三連単馬番６１", max_length=2, null=True)
    Horce_No_6_2 = models.CharField(verbose_name="三連単馬番６２", max_length=2, null=True)
    Horce_No_6_3 = models.CharField(verbose_name="三連単馬番６３", max_length=2, null=True)
