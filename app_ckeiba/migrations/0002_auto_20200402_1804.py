# Generated by Django 2.1.4 on 2020-04-02 09:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Breed_age_name', models.CharField(blank=True, max_length=10, verbose_name='競走種別用名称')),
                ('Breed_age_age_name', models.CharField(blank=True, max_length=10, verbose_name='馬齢条件用名称')),
                ('Breed_age_breed_name', models.CharField(blank=True, max_length=10, verbose_name='品種年齢名称')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Grade_name', models.CharField(blank=True, max_length=5, verbose_name='グレード名称')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Haishin_yobi', models.CharField(blank=True, max_length=30, null=True, verbose_name='予備')),
                ('Company_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_ckeiba.Mst_Company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Jou_1corner', models.CharField(blank=True, max_length=5, verbose_name='１コーナー名称')),
                ('Jou_2corner', models.CharField(blank=True, max_length=5, verbose_name='２コーナー名称')),
                ('Jou_3corner', models.CharField(blank=True, max_length=5, verbose_name='３コーナー名称')),
                ('Jou_4corner', models.CharField(blank=True, max_length=5, verbose_name='４コーナー名称')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Night_race_code', models.IntegerField(verbose_name='ナイタ区分コード')),
                ('Night_race_name', models.CharField(max_length=5, verbose_name='ナイタ区分名称')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='Jou_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_ckeiba.Mst_Jou'),
        ),
        migrations.AddField(
