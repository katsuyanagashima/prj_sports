...
urlpatterns = [
    ...
    path('shussouhyou/<int:year>/<int:month>/<int:day>/<int:joucode>/<int:race>/', views.md_update_shussouhyou_forms, name='shussouhyou'),  #中間DB_出走表編集画面
    path('seiseki/<int:year>/<int:month>/<int:day>/<int:joucode>/<int:race>/', views.md_update_seiseki_haraimodoshi_forms, name='seiseki'),  #中間DB_成績・払戻編集画面
