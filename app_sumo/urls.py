...
urlpatterns = [
    ...
    path('SUMYUS01/update_or_create/<str:str_award>', views.SUMYUS01_update_or_create, name='SUMYUS01_update_or_create'),  # 優勝・三賞入力画面（更新・作成）
    path('SUMYUS01/update_or_delete/', views.SUMYUS01_update_or_delete, name='SUMYUS01_update_or_delete'),  # 優勝・三賞入力画面（更新・削除）
    path('SUMYUS01/create/', views.SUMYUS01_create, name='SUMYUS01_create'),  # 優勝・三賞入力画面（作成）●廃止予定●
    ###path('SUMYUS01/view/<int:pk>', views.SUMYUS01_view, name='SUMYUS01_view'),  # 優勝・三賞入力画面（参照）●廃止●
    path('SUMYUS01/update/<int:pk>', views.SUMYUS01_update, name='SUMYUS01_update'),  # 優勝・三賞入力画面（更新）●廃止予定●
    path('SUMYUS01/delete/<int:pk>', views.SUMYUS01_delete, name='SUMYUS01_delete'),  # 優勝・三賞入力画面（削除）●廃止予定●
