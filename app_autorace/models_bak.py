...
class Trn_Schedule(models.Model):
    ...
    Track_code1_1 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_1_1 = models.IntegerField('レース数１＿１', blank=True, null=True)
    Track_code1_2 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_1_2 = models.IntegerField('レース数１＿２', blank=True, null=True)
    Track_code1_3 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_1_3 = models.IntegerField('レース数１＿３', blank=True, null=True)
    Track_code1_4 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_1_4 = models.IntegerField('レース数１＿４', blank=True, null=True)
    Track_code1_5 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_1_5 = models.IntegerField('レース数１＿５', blank=True, null=True)
    Track_code1_6 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Track_code2_1 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_2_1 = models.IntegerField('レース数２＿１', blank=True, null=True)
    Track_code2_2 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_2_2 = models.IntegerField('レース数２＿２', blank=True, null=True)
    Track_code2_3 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_2_3 = models.IntegerField('レース数２＿３', blank=True, null=True)
    Track_code2_4 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_2_4 = models.IntegerField('レース数２＿４', blank=True, null=True)
    Track_code2_5 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_2_5 = models.IntegerField('レース数２＿５', blank=True, null=True)
    Track_code2_6 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Track_code3_1 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_3_1 = models.IntegerField('レース数３＿１', blank=True, null=True)
    Track_code3_2 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_3_2 = models.IntegerField('レース数３＿２', blank=True, null=True)
    Track_code3_3 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_3_3 = models.IntegerField('レース数３＿３', blank=True, null=True)
    Track_code3_4 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_3_4 = models.IntegerField('レース数３＿４', blank=True, null=True)
    Track_code3_5 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    races_3_5 = models.IntegerField('レース数３＿５', blank=True, null=True)
    Track_code3_6 = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
...
class Trn_Running_list(models.Model):
    ...
    Last_1_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_2_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_3_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_4_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_5_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_6_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_7_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_8_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_9_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    Last_10_Track = models.ForeignKey('Mst_Race_track', on_delete=models.CASCADE, blank=True, null=True, max_length=1)
    ...
    class Meta:
        ...
        def __str__(self):
            return self.Last_1_test_run_time
...
class Trn_Result(models.Model):
    ...
    visitors__day = models.IntegerField('当日入場者数', blank=True, null=True)
    visitors__period = models.IntegerField('当該節入場者数', blank=True, null=True)
    visitors__held = models.IntegerField('当該回入場者数', blank=True, null=True)
    Race_No = models.IntegerField('レース№', blank=True, null=True)
    Race_name = models.CharField('レース名称', blank=True, null=True, max_length=26)
    Race_distance = models.IntegerField('競走距離', blank=True, null=True)
