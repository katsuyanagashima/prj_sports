...
class Program():
    ...
    # 出走選手テーブル 繰り返し×8
    def insert_or_update_trn_running_list(self, trn_running_list_line, repeat, Trn_Running_list):
    ...
    def insert_or_update_trn_program_list(self, line, repeat, Trn_Program, Trn_Running_list):
        ...
        self.insert_or_update_trn_running_list(line, repeat, Trn_Running_list)
            ...
            for line in file:
                ...
                with transaction.atomic():
                    ...
                    for repeat in range(trn_program_repeat):
                        ...
                        self.insert_or_update_trn_program_list(line, repeat, Trn_Program, Trn_Running_list)
