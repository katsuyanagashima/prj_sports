...
class Trn_Rider_results(models.Model):
    ...
    Date_AD = models.CharField('開催日（西暦）', blank=True, null=True, max_length=8)
    Race_No = models.CharField('レース№', blank=True, null=True, max_length=2)
    Bracket_No_1 =  models.CharField('連勝番号', blank=True, null=True, max_length=1)
    Rider_No_1 = models.CharField('車番', blank=True, null=True, max_length=1)
    Rider_code_1 = models.CharField('選手コード', blank=True, null=True, max_length=4)
    Rider_full_name_1 = models.CharField('選手名（フルネーム）', blank=True, null=True, max_length=16)
    Rider_shortened_3_name_1 = models.CharField('選手名（短縮３文字）', blank=True, null=True, max_length=6)
    Rider_shortened_4_name_1 = models.CharField('選手名（短縮４文字）', blank=True, null=True, max_length=8)
    LG_name_1 = models.CharField('ＬＧ名', blank=True, null=True, max_length=6)
    LG_code_1 = models.CharField('ＬＧコード', blank=True, null=True, max_length=1)
    Nickname_1 = models.CharField('呼名', blank=True, null=True, max_length=12)
    Rider_birthplace_1 = models.CharField('選手出身地', blank=True, null=True, max_length=6)
    Rider_Age_1 = models.CharField('年齢', blank=True, null=True, max_length=2)
    By_period_1 = models.CharField('期別', blank=True, null=True, max_length=2)
    Handicap_1 = models.CharField('ハンデ', blank=True, null=True, max_length=3)
    Result_1 = models.CharField('着', blank=True, null=True, max_length=1)
    Accident_code_1 = models.CharField('事故コード', blank=True, null=True, max_length=2)
    Accident_name_1 = models.CharField('事故名称', blank=True, null=True, max_length=6)
    Illegal_start_code_1 = models.CharField('異常発走コード', blank=True, null=True, max_length=1)
    Disturbed_code_1 = models.CharField('被妨害コード', blank=True, null=True, max_length=1)
    Test_run_time_1 = models.CharField('試走タイム', blank=True, null=True, max_length=4)
    Race_time_1 = models.CharField('競走タイム', blank=True, null=True, max_length=4)
    Minute_second_1 = models.CharField('分秒', blank=True, null=True, max_length=4)
    Start_timing_1 = models.CharField('スタートタイミング', blank=True, null=True, max_length=2)
    #選手2
    Bracket_No_2 =  models.CharField('連勝番号', blank=True, null=True, max_length=1)
    Rider_No_2 = models.CharField('車番', blank=True, null=True, max_length=1)
    Rider_code_2 = models.CharField('選手コード', blank=True, null=True, max_length=4)
    Rider_full_name_2 = models.CharField('選手名（フルネーム）', blank=True, null=True, max_length=16)
    Rider_shortened_3_name_2 = models.CharField('選手名（短縮３文字）', blank=True, null=True, max_length=6)
    Rider_shortened_4_name_2 = models.CharField('選手名（短縮４文字）', blank=True, null=True, max_length=8)
    LG_name_2 = models.CharField('ＬＧ名', blank=True, null=True, max_length=6)
    LG_code_2 = models.CharField('ＬＧコード', blank=True, null=True, max_length=1)
    Nickname_2 = models.CharField('呼名', blank=True, null=True, max_length=12)
    Rider_birthplace_2 = models.CharField('選手出身地', blank=True, null=True, max_length=6)
    Rider_Age_2 = models.CharField('年齢', blank=True, null=True, max_length=2)
    By_period_2 = models.CharField('期別', blank=True, null=True, max_length=2)
    Handicap_2 = models.CharField('ハンデ', blank=True, null=True, max_length=3)
    Result_2 = models.CharField('着', blank=True, null=True, max_length=1)
    Accident_code_2 = models.CharField('事故コード', blank=True, null=True, max_length=2)
    Accident_name_2 = models.CharField('事故名称', blank=True, null=True, max_length=6)
    Illegal_start_code_2 = models.CharField('異常発走コード', blank=True, null=True, max_length=1)
    Disturbed_code_2 = models.CharField('被妨害コード', blank=True, null=True, max_length=1)
    Test_run_time_2 = models.CharField('試走タイム', blank=True, null=True, max_length=4)
    Race_time_2 = models.CharField('競走タイム', blank=True, null=True, max_length=4)
    Minute_second_2 = models.CharField('分秒', blank=True, null=True, max_length=4)
    Start_timing_2 = models.CharField('スタートタイミング', blank=True, null=True, max_length=2)
    #選手3
    Bracket_No_3 =  models.CharField('連勝番号', blank=True, null=True, max_length=1)
    Rider_No_3 = models.CharField('車番', blank=True, null=True, max_length=1)
    Rider_code_3 = models.CharField('選手コード', blank=True, null=True, max_length=4)
    Rider_full_name_3 = models.CharField('選手名（フルネーム）', blank=True, null=True, max_length=16)
    Rider_shortened_3_name_3 = models.CharField('選手名（短縮３文字）', blank=True, null=True, max_length=6)
    Rider_shortened_4_name_3 = models.CharField('選手名（短縮４文字）', blank=True, null=True, max_length=8)
    LG_name_3 = models.CharField('ＬＧ名', blank=True, null=True, max_length=6)
    LG_code_3 = models.CharField('ＬＧコード', blank=True, null=True, max_length=1)
    Nickname_3 = models.CharField('呼名', blank=True, null=True, max_length=12)
    Rider_birthplace_3 = models.CharField('選手出身地', blank=True, null=True, max_length=6)
    Rider_Age_3 = models.CharField('年齢', blank=True, null=True, max_length=2)
    By_period_3 = models.CharField('期別', blank=True, null=True, max_length=2)
    Handicap_3 = models.CharField('ハンデ', blank=True, null=True, max_length=3)
    Result_3 = models.CharField('着', blank=True, null=True, max_length=1)
    Accident_code_3 = models.CharField('事故コード', blank=True, null=True, max_length=2)
    Accident_name_3 = models.CharField('事故名称', blank=True, null=True, max_length=6)
    Illegal_start_code_3 = models.CharField('異常発走コード', blank=True, null=True, max_length=1)
    Disturbed_code_3 = models.CharField('被妨害コード', blank=True, null=True, max_length=1)
    Test_run_time_3 = models.CharField('試走タイム', blank=True, null=True, max_length=4)
    Race_time_3 = models.CharField('競走タイム', blank=True, null=True, max_length=4)
    Minute_second_3 = models.CharField('分秒', blank=True, null=True, max_length=4)
    Start_timing_3 = models.CharField('スタートタイミング', blank=True, null=True, max_length=2)
    #選手4
    Bracket_No_4 =  models.CharField('連勝番号', blank=True, null=True, max_length=1)
    Rider_No_4 = models.CharField('車番', blank=True, null=True, max_length=1)
    Rider_code_4 = models.CharField('選手コード', blank=True, null=True, max_length=4)
    Rider_full_name_4 = models.CharField('選手名（フルネーム）', blank=True, null=True, max_length=16)
    Rider_shortened_3_name_4 = models.CharField('選手名（短縮３文字）', blank=True, null=True, max_length=6)
    Rider_shortened_4_name_4 = models.CharField('選手名（短縮４文字）', blank=True, null=True, max_length=8)
    LG_name_4 = models.CharField('ＬＧ名', blank=True, null=True, max_length=6)
    LG_code_4 = models.CharField('ＬＧコード', blank=True, null=True, max_length=1)
    Nickname_4 = models.CharField('呼名', blank=True, null=True, max_length=12)
    Rider_birthplace_4 = models.CharField('選手出身地', blank=True, null=True, max_length=6)
    Rider_Age_4 = models.CharField('年齢', blank=True, null=True, max_length=2)
    By_period_4 = models.CharField('期別', blank=True, null=True, max_length=2)
    Handicap_4 = models.CharField('ハンデ', blank=True, null=True, max_length=3)
    Result_4 = models.CharField('着', blank=True, null=True, max_length=1)
    Accident_code_4 = models.CharField('事故コード', blank=True, null=True, max_length=2)
    Accident_name_4 = models.CharField('事故名称', blank=True, null=True, max_length=6)
    Illegal_start_code_4 = models.CharField('異常発走コード', blank=True, null=True, max_length=1)
    Disturbed_code_4 = models.CharField('被妨害コード', blank=True, null=True, max_length=1)
    Test_run_time_4 = models.CharField('試走タイム', blank=True, null=True, max_length=4)
    Race_time_4 = models.CharField('競走タイム', blank=True, null=True, max_length=4)
    Minute_second_4 = models.CharField('分秒', blank=True, null=True, max_length=4)
    Start_timing_4 = models.CharField('スタートタイミング', blank=True, null=True, max_length=2)
    #選手5
    Bracket_No_5 =  models.CharField('連勝番号', blank=True, null=True, max_length=1)
    Rider_No_5 = models.CharField('車番', blank=True, null=True, max_length=1)
    Rider_code_5 = models.CharField('選手コード', blank=True, null=True, max_length=4)
    Rider_full_name_5 = models.CharField('選手名（フルネーム）', blank=True, null=True, max_length=16)
    Rider_shortened_3_name_5 = models.CharField('選手名（短縮３文字）', blank=True, null=True, max_length=6)
    Rider_shortened_4_name_5 = models.CharField('選手名（短縮４文字）', blank=True, null=True, max_length=8)
    LG_name_5 = models.CharField('ＬＧ名', blank=True, null=True, max_length=6)
    LG_code_5 = models.CharField('ＬＧコード', blank=True, null=True, max_length=1)
    Nickname_5 = models.CharField('呼名', blank=True, null=True, max_length=12)
    Rider_birthplace_5 = models.CharField('選手出身地', blank=True, null=True, max_length=6)
    Rider_Age_5 = models.CharField('年齢', blank=True, null=True, max_length=2)
    By_period_5 = models.CharField('期別', blank=True, null=True, max_length=2)
    Handicap_5 = models.CharField('ハンデ', blank=True, null=True, max_length=3)
    Result_5 = models.CharField('着', blank=True, null=True, max_length=1)
    Accident_code_5 = models.CharField('事故コード', blank=True, null=True, max_length=2)
    Accident_name_5 = models.CharField('事故名称', blank=True, null=True, max_length=6)
    Illegal_start_code_5 = models.CharField('異常発走コード', blank=True, null=True, max_length=1)
    Disturbed_code_5 = models.CharField('被妨害コード', blank=True, null=True, max_length=1)
    Test_run_time_5 = models.CharField('試走タイム', blank=True, null=True, max_length=4)
    Race_time_5 = models.CharField('競走タイム', blank=True, null=True, max_length=4)
    Minute_second_5 = models.CharField('分秒', blank=True, null=True, max_length=4)
    Start_timing_5 = models.CharField('スタートタイミング', blank=True, null=True, max_length=2)
    #選手6
    Bracket_No_6 =  models.CharField('連勝番号', blank=True, null=True, max_length=1)
    Rider_No_6 = models.CharField('車番', blank=True, null=True, max_length=1)
    Rider_code_6 = models.CharField('選手コード', blank=True, null=True, max_length=4)
    Rider_full_name_6 = models.CharField('選手名（フルネーム）', blank=True, null=True, max_length=16)
    Rider_shortened_3_name_6 = models.CharField('選手名（短縮３文字）', blank=True, null=True, max_length=6)
    Rider_shortened_4_name_6 = models.CharField('選手名（短縮４文字）', blank=True, null=True, max_length=8)
    LG_name_6 = models.CharField('ＬＧ名', blank=True, null=True, max_length=6)
    LG_code_6 = models.CharField('ＬＧコード', blank=True, null=True, max_length=1)
    Nickname_6 = models.CharField('呼名', blank=True, null=True, max_length=12)
    Rider_birthplace_6 = models.CharField('選手出身地', blank=True, null=True, max_length=6)
    Rider_Age_6 = models.CharField('年齢', blank=True, null=True, max_length=2)
    By_period_6 = models.CharField('期別', blank=True, null=True, max_length=2)
    Handicap_6 = models.CharField('ハンデ', blank=True, null=True, max_length=3)
    Result_6 = models.CharField('着', blank=True, null=True, max_length=1)
    Accident_code_6 = models.CharField('事故コード', blank=True, null=True, max_length=2)
    Accident_name_6 = models.CharField('事故名称', blank=True, null=True, max_length=6)
    Illegal_start_code_6 = models.CharField('異常発走コード', blank=True, null=True, max_length=1)
    Disturbed_code_6 = models.CharField('被妨害コード', blank=True, null=True, max_length=1)
    Test_run_time_6 = models.CharField('試走タイム', blank=True, null=True, max_length=4)
    Race_time_6 = models.CharField('競走タイム', blank=True, null=True, max_length=4)
    Minute_second_6 = models.CharField('分秒', blank=True, null=True, max_length=4)
    Start_timing_6 = models.CharField('スタートタイミング', blank=True, null=True, max_length=2)
    #選手7
    Bracket_No_7 =  models.CharField('連勝番号', blank=True, null=True, max_length=1)
    Rider_No_7 = models.CharField('車番', blank=True, null=True, max_length=1)
    Rider_code_7 = models.CharField('選手コード', blank=True, null=True, max_length=4)
    Rider_full_name_7 = models.CharField('選手名（フルネーム）', blank=True, null=True, max_length=16)
    Rider_shortened_3_name_7 = models.CharField('選手名（短縮３文字）', blank=True, null=True, max_length=6)
    Rider_shortened_4_name_7 = models.CharField('選手名（短縮４文字）', blank=True, null=True, max_length=8)
    LG_name_7 = models.CharField('ＬＧ名', blank=True, null=True, max_length=6)
    LG_code_7 = models.CharField('ＬＧコード', blank=True, null=True, max_length=1)
    Nickname_7 = models.CharField('呼名', blank=True, null=True, max_length=12)
    Rider_birthplace_7 = models.CharField('選手出身地', blank=True, null=True, max_length=6)
    Rider_Age_7 = models.CharField('年齢', blank=True, null=True, max_length=2)
    By_period_7 = models.CharField('期別', blank=True, null=True, max_length=2)
    Handicap_7 = models.CharField('ハンデ', blank=True, null=True, max_length=3)
    Result_7 = models.CharField('着', blank=True, null=True, max_length=1)
    Accident_code_7 = models.CharField('事故コード', blank=True, null=True, max_length=2)
    Accident_name_7 = models.CharField('事故名称', blank=True, null=True, max_length=6)
    Illegal_start_code_7 = models.CharField('異常発走コード', blank=True, null=True, max_length=1)
    Disturbed_code_7 = models.CharField('被妨害コード', blank=True, null=True, max_length=1)
    Test_run_time_7 = models.CharField('試走タイム', blank=True, null=True, max_length=4)
    Race_time_7 = models.CharField('競走タイム', blank=True, null=True, max_length=4)
    Minute_second_7 = models.CharField('分秒', blank=True, null=True, max_length=4)
    Start_timing_7 = models.CharField('スタートタイミング', blank=True, null=True, max_length=2)
    #選手8
    Bracket_No_8 =  models.CharField('連勝番号', blank=True, null=True, max_length=1)
    Rider_No_8 = models.CharField('車番', blank=True, null=True, max_length=1)
    Rider_code_8 = models.CharField('選手コード', blank=True, null=True, max_length=4)
    Rider_full_name_8 = models.CharField('選手名（フルネーム）', blank=True, null=True, max_length=16)
    Rider_shortened_3_name_8 = models.CharField('選手名（短縮３文字）', blank=True, null=True, max_length=6)
    Rider_shortened_4_name_8 = models.CharField('選手名（短縮４文字）', blank=True, null=True, max_length=8)
    LG_name_8 = models.CharField('ＬＧ名', blank=True, null=True, max_length=6)
    LG_code_8 = models.CharField('ＬＧコード', blank=True, null=True, max_length=1)
    Nickname_8 = models.CharField('呼名', blank=True, null=True, max_length=12)
    Rider_birthplace_8 = models.CharField('選手出身地', blank=True, null=True, max_length=6)
    Rider_Age_8 = models.CharField('年齢', blank=True, null=True, max_length=2)
    By_period_8 = models.CharField('期別', blank=True, null=True, max_length=2)
    Handicap_8 = models.CharField('ハンデ', blank=True, null=True, max_length=3)
    Result_8 = models.CharField('着', blank=True, null=True, max_length=1)
    Accident_code_8 = models.CharField('事故コード', blank=True, null=True, max_length=2)
    Accident_name_8 = models.CharField('事故名称', blank=True, null=True, max_length=6)
    Illegal_start_code_8 = models.CharField('異常発走コード', blank=True, null=True, max_length=1)
    Disturbed_code_8 = models.CharField('被妨害コード', blank=True, null=True, max_length=1)
    Test_run_time_8 = models.CharField('試走タイム', blank=True, null=True, max_length=4)
    Race_time_8 = models.CharField('競走タイム', blank=True, null=True, max_length=4)
    Minute_second_8 = models.CharField('分秒', blank=True, null=True, max_length=4)
    Start_timing_8 = models.CharField('スタートタイミング', blank=True, null=True, max_length=2)
