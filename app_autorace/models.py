...
class Trn_Outside_track(models.Model):
    ...
    Note_code_3 = models.CharField('注釈コード＿３', blank=True, null=True, max_length=2)
    ...
    OTB_10 = models.CharField('売場名＿１０', blank=True, null=True, max_length=6)
    ...
    OTB_11 = models.CharField('売場名＿１１', blank=True, null=True, max_length=6)
    ...
    OTB_12 = models.CharField('売場名＿１２', blank=True, null=True, max_length=6)
    ...
    OTB_13 = models.CharField('売場名＿１３', blank=True, null=True, max_length=6)
    ...
    OTB_14 = models.CharField('売場名＿１４', blank=True, null=True, max_length=6)
    ...
    OTB_15 = models.CharField('売場名＿１５', blank=True, null=True, max_length=6)
    ...
    OTB_16 = models.CharField('売場名＿１６', blank=True, null=True, max_length=6)
    ...
    OTB_17 = models.CharField('売場名＿１７', blank=True, null=True, max_length=6)
    ...
    OTB_18 = models.CharField('売場名＿１８', blank=True, null=True, max_length=6)
    ...
    OTB_19 = models.CharField('売場名＿１９', blank=True, null=True, max_length=6)
    ...
    OTB_20 = models.CharField('売場名＿２０', blank=True, null=True, max_length=6)
