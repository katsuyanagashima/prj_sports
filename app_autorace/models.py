...
class Trn_Schedule(models.Model):
    ...
    races_1_1 = models.CharField('レース数１＿１', blank=True, null=True, max_length=1)
    Track_code1_2 = models.CharField('場コード１＿２', blank=True, null=True, max_length=1)
    races_1_2 = models.CharField('レース数１＿２', blank=True, null=True, max_length=1)
    Track_code1_3 = models.CharField('場コード１＿３', blank=True, null=True, max_length=1)
    races_1_3 = models.CharField('レース数１＿３', blank=True, null=True, max_length=1)
    Track_code1_4 = models.CharField('場コード１＿４', blank=True, null=True, max_length=1)
    races_1_4 = models.CharField('レース数１＿４', blank=True, null=True, max_length=1)
    Track_code1_5 = models.CharField('場コード１＿５', blank=True, null=True, max_length=1)
    races_1_5 = models.CharField('レース数１＿５', blank=True, null=True, max_length=1)
    Track_code1_6 = models.CharField('場コード１＿６', blank=True, null=True, max_length=1)
    races_1_6 = models.CharField('レース数１＿６', blank=True, null=True, max_length=1)
    ...
    races_2_1 = models.CharField('レース数２＿１', blank=True, null=True, max_length=1)
    Track_code2_2 = models.CharField('場コード２＿２', blank=True, null=True, max_length=1)
    races_2_2 = models.CharField('レース数２＿２', blank=True, null=True, max_length=1)
    Track_code2_3 = models.CharField('場コード２＿３', blank=True, null=True, max_length=1)
    races_2_3 = models.CharField('レース数２＿３', blank=True, null=True, max_length=1)
    Track_code2_4 = models.CharField('場コード２＿４', blank=True, null=True, max_length=1)
    races_2_4 = models.CharField('レース数２＿４', blank=True, null=True, max_length=1)
    Track_code2_5 = models.CharField('場コード２＿５', blank=True, null=True, max_length=1)
    races_2_5 = models.CharField('レース数２＿５', blank=True, null=True, max_length=1)
    Track_code2_6 = models.CharField('場コード２＿６', blank=True, null=True, max_length=1)
    races_2_6 = models.CharField('レース数２＿６', blank=True, null=True, max_length=1)
    ...
    races_3_1 = models.CharField('レース数３＿１', blank=True, null=True, max_length=1)
    Track_code3_2 = models.CharField('場コード３＿２', blank=True, null=True, max_length=1)
    races_3_2 = models.CharField('レース数３＿２', blank=True, null=True, max_length=1)
    Track_code3_3 = models.CharField('場コード３＿３', blank=True, null=True, max_length=1)
    races_3_3 = models.CharField('レース数３＿３', blank=True, null=True, max_length=1)
    Track_code3_4 = models.CharField('場コード３＿４', blank=True, null=True, max_length=1)
    races_3_4 = models.CharField('レース数３＿４', blank=True, null=True, max_length=1)
    Track_code3_5 = models.CharField('場コード３＿５', blank=True, null=True, max_length=1)
    races_3_5 = models.CharField('レース数３＿５', blank=True, null=True, max_length=1)
    Track_code3_6 = models.CharField('場コード３＿６', blank=True, null=True, max_length=1)
    races_3_6 = models.CharField('レース数３＿６', blank=True, null=True, max_length=1)
